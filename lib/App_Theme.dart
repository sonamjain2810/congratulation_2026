...
class AppTheme {
  ...
  static  final Color _lightPrimaryColor = Colors.indigoAccent.shade200;
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      bodyLarge: GoogleFonts.ptSans(
        textStyle: const TextStyle(color: _lightSecondaryColor),
      ),
...
// light Appbar text Styling
  static final TextTheme _lightAppBarTextTextTheme = TextTheme(
    displayLarge: GoogleFonts.lobster(textStyle: _lightAppBarHeadline1TextStyle),
  );
...
//textTheme: _darkAppBarTextTextTheme,
  ...
  static final TextTheme _darkAppBarTextTextTheme = TextTheme(
    displayLarge: GoogleFonts.lobster(textStyle: _darkAppBarHeadline1TextStyle),
  );
